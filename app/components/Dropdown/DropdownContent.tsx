...
const DropdownContent = ({ children }: DropdownContentProps) => {
  ...
  return (
    <div
      ...
      } transition-all duration-300 absolute w-full top-full left-0 mt-2 md:mt-4 lg:mt-6 select-none bg-white dark:bg-midnight-slate rounded-lg shadow-primary-25`}
    >
      {children}
    </div>
  );
